...
<section class="py-16">
    <div class="max-w-2xl mx-auto px-4">
        <h1 class="text-4xl font-bold mb-8">Edit Project</h1>
        ...
        <form action="{{ route('admin.projects.update', $project->id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-lg shadow">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="6" required 
                    class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-600">{{ old('description', $project->description) }}</textarea>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" name="technology_stack" value="{{ old('technology_stack', $project->technology_stack) }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-600"
